...
![A screen shot of the Microsoft Artifact Registry, with a view filtered to show the DevOps and Programming Languages categories.](pathname:///assets/img/content/Microsoft-Artifact-Registry.png)
...
![A screen shot of the Windows Terminal running the above commands.](pathname:///assets/img/content/MAR-Repository-Setup.png)
...
![The output of running `Get-InstalledPSResource -Name Az.*`.](pathname:///assets/img/content/MAR-Modules-Installed.png)

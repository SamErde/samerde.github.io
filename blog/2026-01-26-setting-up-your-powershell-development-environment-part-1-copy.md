...
description: 'Create a clean separation between work and personal projects with an organized directory structure'
slug: '/2026-01-26-setting-up-your-powershell-development-environment-part-1-copy/'
date: '2026-01-26'
authors: [sam]
tags: ['PowerShell', 'Development', 'Git', 'Productivity']
image: 'https://day3bits.com/assets/img/social/Setting-Up-PowerShell-Development-Environment-Part-1.png'
cover_image: '/assets/img/banners/yosuke-ota-GUcabuY3q80-unsplash.jpg'
thumbnail_image: '/assets/img/thumbnails/yosuke-ota-GUcabuY3q80-unsplash-small.jpg'
---
...
![A screen shot of Windows Explorer with the pinned Code folder and subst drives.](pathname:///assets/img/content/Windows-Explorer-With-Subst-Drives.png)

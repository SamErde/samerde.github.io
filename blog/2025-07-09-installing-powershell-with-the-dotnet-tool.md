...
![Windows Terminal with a profile added for the PowerShell .NET tool](pathname:///assets/img/content/Windows-Terminal-PowerShell-dotnet-global-tool-profile.png)
...
![PowerShell in Windows Terminal showing the output of Invoke-RestMethod getting two PowerShell release info URIs. ](pathname:///assets/img/content/PowerShell-LTS-Version-Release-Commands.png)
